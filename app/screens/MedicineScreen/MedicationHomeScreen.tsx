...
export default function MedicationHomeScreen() {
  ...
  const handleCheck = (id) => toggleChecked(selectedDate.toISOString().split('T')[0], id);
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 16, shadowColor: '#000', shadowOpacity: 0.05, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 1 },
