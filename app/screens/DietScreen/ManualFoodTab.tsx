  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={handleNavigate}>
        <Text style={styles.buttonText}>직접 등록하기</Text>
      </TouchableOpacity>
          ...
          manualFoods.map((item) => {
            ...
            return (
              <View key={item.id} style={styles.card}>
                ...
                <Text style={styles.detail}>총 중량: {item.weight} g</Text>
      ...
      {selectedCount > 0 && (
        <View style={styles.actionRow}>
          <TouchableOpacity style={styles.registerBtn} onPress={handleRegisterSelected}>
            <Text style={styles.registerText}>선택한 음식 등록</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.deleteBtn} onPress={handleDeleteSelected}>
            <Text style={styles.registerText}>선택한 음식 삭제</Text>
          </TouchableOpacity>
        </View>
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: '#2678E4', paddingVertical: 12, paddingHorizontal: 24,
  ...
  editBtn: {
    backgroundColor: '#F05636', paddingVertical: 6,
    paddingHorizontal: 12, borderRadius: 6, marginRight: 6,
  },
