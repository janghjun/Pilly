...
const TIME_SLOTS = ['breakfast', 'lunch', 'dinner', 'snack'];
const TIME_LABELS = {
  breakfast: '아침',
  lunch: '점심',
  dinner: '저녁',
...
export default function DailySummaryScreen() {
  ...
  const [tab, setTab] = useState<'nutrition' | 'food'>('nutrition');
  ...
  const {
    ...
    const safe = (n: any) => typeof n === 'number' ? n : parseFloat(n) || 0;
    ...
    const macroChart = [
      { name: '탄수화물', population: totalCarb, color: '#fcbf49', legendFontColor: '#333', legendFontSize: 12 },
      { name: '단백질', population: totalProtein, color: '#90be6d', legendFontColor: '#333', legendFontSize: 12 },
      { name: '지방', population: totalFat, color: '#577590', legendFontColor: '#333', legendFontSize: 12 }
    ];
...
const styles = StyleSheet.create({
  ...
  valText: { color: '#2678E4', fontWeight: 'bold' },
  ...
  foodBadge: { backgroundColor: '#eee', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10, marginRight: 6, marginBottom: 6 },
