// DietGoalAndBackup.tsx - 백업 파일 이름 개선 및 목표 Context 연동 준비
...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: '#ccc', padding: 10, borderRadius: 6, marginBottom: 10, textAlign: 'right' },
  button: { backgroundColor: '#57c', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 15 },
